...
import 'ElmProjects', './elements/elm_projects'
window.custom_elements.define('elm-projects', ElmProjects)

import 'ElmVideos', './elements/elm_videos'
window.custom_elements.define('elm-videos', ElmVideos)
...
import 'ElmAdminArticle', './elements/elm_admin_article'
